---
description: 'Java style rules: Sun Checkstyle conventions, JSpecify nullability, and JDK 21 idioms.'
applyTo: '**/*.java'
---

# Java Style Rules

These instructions configure GitHub Copilot to follow Java conventions when generating or refactoring Java code.
